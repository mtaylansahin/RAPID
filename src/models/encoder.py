...
class RAPIDEncoder(nn.Module):
    ...
    def forward(
        ...
        """
        Encode all entities into context matrix.

        Args:
            graph_dict: Dict mapping timestep -> DGLGraph
            entity_history: Per-entity history lists
        ...
        """
        return self.rapid.encode_context(
            graph_dict, entity_history, entity_history_t, global_emb
        )
